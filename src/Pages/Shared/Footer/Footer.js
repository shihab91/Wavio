      ...
      <Container>
        <Grid container spacing={4}>
          <Grid item xs={12} sm={6} md={4}>
            <List>
              <Typography variant="h6" sx={{ textAlign: "left", ml: 2 }}> <Box sx={{
                color: "var(--color)", display: "inline-block", fontWeight: "bold"
              }}> | </Box> Menu</Typography>
          ...
          <Grid item xs={12} sm={6} md={4} sx={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'flex-start' }}>
            <Typography variant="h6" sx={{ textAlign: "left", ml: 2 }}> <Box sx={{
              color: "var(--color)", display: "inline-block", fontWeight: "bold"
            }}> | </Box> Contact Us</Typography>
            <Typography variant="body1" sx={{ textAlign: "left", ml: 2, my: 2 }}>
              51st St, New York, NY 10019
            </Typography>
            <Typography variant="body1" sx={{ textAlign: "left", ml: 2 }}>
              Call Us: 212.262.3200
            </Typography>
            <Typography variant="h6" sx={{ textAlign: "left", ml: 2, mt: 3 }}> <Box sx={{
              color: "var(--color)", display: "inline-block", fontWeight: "bold"
            }}> | </Box> Social Media Links</Typography>
            <Box sx={{ ml: 2, mt: 3 }}>
          ...
          <Grid item xs={12} sm={6} md={4} >
            <Box >
              ...
              <Button variant="contained" sx={{ background: "var(--button-bg)" }}>Subscribe</Button>
            </Box>
          </Grid>
        </Grid>
      </Container>
